...
export declare type ColumnHeaderCellProps = IColumnHeaderCellProps;
...
export declare class ColumnHeaderCell extends AbstractPureComponent2<IColumnHeaderCellProps, IColumnHeaderCellState> {
    ...
    static contextTypes: React.ValidationMap<ColumnInteractionBarContextTypes>;
    /**
    ...
    context: ColumnInteractionBarContextTypes;
    state: {
        isActive: boolean;
    };
    render(): JSX.Element;
