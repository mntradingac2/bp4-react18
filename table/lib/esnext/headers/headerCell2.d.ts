...
export declare class HeaderCell2 extends React.Component<HeaderCell2Props, HeaderCell2State> {
    state: HeaderCell2State;
    shouldComponentUpdate(nextProps: HeaderCell2Props): boolean;
    render(): JSX.Element;
}
