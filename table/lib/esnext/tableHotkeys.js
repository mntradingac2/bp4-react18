...
export class TableHotkeys {
    ...
    // Focus
    // =====
    handleFocusMoveLeft = (e) => this.handleFocusMove(e, "left");
    handleFocusMoveLeftInternal = (e) => this.handleFocusMoveInternal(e, "left");
    handleFocusMoveRight = (e) => this.handleFocusMove(e, "right");
    handleFocusMoveRightInternal = (e) => this.handleFocusMoveInternal(e, "right");
    handleFocusMoveUp = (e) => this.handleFocusMove(e, "up");
    handleFocusMoveUpInternal = (e) => this.handleFocusMoveInternal(e, "up");
    handleFocusMoveDown = (e) => this.handleFocusMove(e, "down");
    handleFocusMoveDownInternal = (e) => this.handleFocusMoveInternal(e, "down");
    ...
    scrollBodyToFocusedCell = (focusedCell) => {
