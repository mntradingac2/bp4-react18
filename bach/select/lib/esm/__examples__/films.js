...
export var renderFilm = function (film, props) {
    ...
    return React.createElement(MenuItem2, __assign({}, getFilmItemProps(film, props)));
};
/**
 * Renders a menu item to create a single film from a given query string.
 */
export var renderCreateFilmMenuItem = function (query, active, handleClick) { return (React.createElement(MenuItem2, { icon: "add", text: "Create \"".concat(query, "\""), roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false })); };
/**
 * Renders a menu item to create one or more films from a given query string.
 */
export var renderCreateFilmsMenuItem = function (query, active, handleClick) { return (React.createElement(MenuItem2, { icon: "add", text: "Create ".concat(printReadableList(query)), roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false })); };
/**
