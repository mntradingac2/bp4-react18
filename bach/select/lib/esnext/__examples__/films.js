 ...
 */
export function getFilmItemProps(film, { handleClick, handleFocus, modifiers, ref, query }) {
    return {
...
export const renderFilm = (film, props) => {
    ...
    return React.createElement(MenuItem2, { ...getFilmItemProps(film, props) });
};
/**
 * Renders a menu item to create a single film from a given query string.
 */
export const renderCreateFilmMenuItem = (query, active, handleClick) => (React.createElement(MenuItem2, { icon: "add", text: `Create "${query}"`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
/**
 * Renders a menu item to create one or more films from a given query string.
 */
export const renderCreateFilmsMenuItem = (query, active, handleClick) => (React.createElement(MenuItem2, { icon: "add", text: `Create ${printReadableList(query)}`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
/**
